...
//------- Replace the following! ------
 ...
 const char* ssid = "Familia crespo" ;         // your network SSID (name)
const char* password = "Jacob4.34"; // your network password

#define TELEGRAM_BOT_TOKEN "6563396156:AAGVXovsTzuhFs-qvMjcjJ-0pLnCjCy6h6Y"
...
#define LED_PIN 26 // Same as D4 for Wemos
  ...
  for (int i = 0; i < numNewMessages; i++) {
    ...
    if (bot.messages[i].type ==  F("callback_query")) {
      ...
      if (text == F("/options")) {
        ...
        bot.sendMessageWithInlineKeyboard(chat_id, "Bot_esp32_", "", keyboardJson);
      }
